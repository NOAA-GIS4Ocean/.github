...
Interested in helping out the NOAA-GIS4Ocean community?
Have a few minutes to tackle an issue? Or improve the documentation?
In this guide we will get you setup and integrated into contributing to NOAA-GIS4Ocean!

## Introduction

First off, thank you for considering contributing.
It's people like you that make the NOAA-GIS4Ocean community useful and successful.
There are many ways to contribute,
from writing tutorials or examples,
improvements to the documentation,
submitting bug reports and feature requests,
or even writing code which can be incorporated into NOAA-GIS4Ocean software for everyone to use.
...
[code of conduct](https://github.com/NOAA-GIS4Ocean/.github/blob/main/CODE_OF_CONDUCT.md).
...
The easiest way to get involved is to report issues you encounter when using this software or by
